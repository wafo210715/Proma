...
import { USER_PROFILE_IPC_CHANNELS, SETTINGS_IPC_CHANNELS, SCRATCH_PAD_IPC_CHANNELS, CANVAS_IPC_CHANNELS, BROWSER_IPC_CHANNELS, SCREEN_CAPTURE_IPC_CHANNELS, QUICK_TASK_IPC_CHANNELS, VOICE_DICTATION_IPC_CHANNELS, APP_ICON_IPC_CHANNELS, DOCK_BADGE_IPC_CHANNELS, STORAGE_IPC_CHANNELS } from '../types'
import type {
...
export function registerIpcHandlers(): void {
  ...
  ipcMain.handle(
    ...
    async (_, title?: string, channelId?: string, workspaceId?: string, modelId?: string, agentRuntime?: AgentRuntime): Promise<AgentSessionMeta> => {
      ...
      const session = createAgentSession(title, channelId, workspaceId, modelId, agentRuntime ?? getSettings().agentRuntime ?? 'pi')
